...
GCOL_Colour_t GCOL_Cyan ={			.r = 0.0f,		.g = 1.0f,		.b = 1.0f,		.a = 1.0f};

GCOL_Colour_t GCOL_Red_3Quarter ={	.r = 0.75f,		.g = 0.0f,		.b = 0.0f,		.a = 1.0f};
GCOL_Colour_t GCOL_Green_3Quarter ={.r = 0.0f,		.g = 0.75f,		.b = 0.0f,		.a = 1.0f};
GCOL_Colour_t GCOL_Blue_3Quarter ={	.r = 0.0f,		.g = 0.0f,		.b = 0.75f,		.a = 1.0f};
GCOL_Colour_t GCOL_Yellow_3Quarter={.r = 0.75f,		.g = 0.75f,		.b = 0.0f,		.a = 1.0f};
GCOL_Colour_t GCOL_Cyan_3Quarter ={	.r = 0.0f,		.g = 0.75f,		.b = 0.75f,		.a = 1.0f};
...
GCOL_Colour_t GCOL_Cyan_Half ={		.r = 0.0f,		.g = 0.5f,		.b = 0.5f,		.a = 1.0f};
...
GCOL_Colour_t GCOL_Cyan_Quarter ={	.r = 0.0f,		.g = 0.25f,		.b = 0.25f,		.a = 1.0f};
...
//GCOL_Colour_t* GCOL_BACK_COLOUR=&GCOL_Green_Half;
//GCOL_Colour_t* GCOL_FORE_COLOUR=&GCOL_Green;
