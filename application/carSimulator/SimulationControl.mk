...
# component name
SIMULATIONCONTROL_OBJ_PATH=$(PROJECT_PATH)/application/$(CARSIMULATOR_COMPONENT_NAME)
...
#------------------------------------------------------------------------------#
# compile object
$(SIMULATIONCONTROL_OBJ): $(SIMULATIONCONTROL_INCLUDES) $(SIMULATIONCONTROL_SRC) $(CARSIMULATOR_COMPONENT_OUTPUT_FOLDER)
